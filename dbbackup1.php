...
<div id="container" class="container_16">
    ...
    <div class="grid_11 omega">
			...
			<iframe src="backup/index.php" width="300" height="200" align="right" scrolling="no">
             </iframe>
            <font color="red"><h4>BackUp your Database!!</br></font>
			</br>
				<center>
				<img src="images/loader.gif" />
				</br>
				<p><strong>BackUp</strong>-To Backup your Database</p>
				<p><strong>Restore</strong>-To Restore your Database</p>
				<div id="content">
    ...
    <div class="grid_16 footer">
        <img src="images/footer-top.png" />
         <div id="footer">
            <p>&copy; 2013 <a href="http://actwithrobots.com"><b><font color="red" style="iceland">Actwith</font><font color="#01A2E8">Robots</a> | <b><font color="green">SIDHU-11249CM011</font></b></p>
        </div><!-- end footer -->
