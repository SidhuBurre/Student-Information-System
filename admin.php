...
<div id="container" class="container_16">
    ...
    <div class="grid_11 omega">
            ...
            <div id="right_col" >
                <h4>Enter new student data&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="dbbackup1.php"><img src="dbbackup.png" alt="BackUp Database" title="BackUp" width="50" height="50"></a></h4>
                <div id="content">
                    ...
                    <form enctype="multipart/form-data" method="post" action="fill_data.php" id="marks_form">
                        ...
                        <div>
                            ...
                            <input type="radio" name="prog" checked="checked" value="Diploma." /><label>Diploma.</label>
                            <input type="radio" name="prog" value="B.tech." /><label>Btech.</label>           
                        </div>
                        <div>
                            ...
                            <input type="radio" name="branch" value="EE" /><label>EN</label>
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="load-en branch">EE</a></li>
                    </ul>   
                    </div>                
